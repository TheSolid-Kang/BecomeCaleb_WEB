...
{
    public partial class _TCUserConfiguration : IEntityTypeConfiguration<_TCUser>
    {
        public void Configure(EntityTypeBuilder<_TCUser> entity)
        {
        ...
        partial void OnConfigurePartial(EntityTypeBuilder<_TCUser> entity);
    }
}
